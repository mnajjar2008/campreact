...
class Main extends Component {
    ...
    render() {
        ...
        const CampsiteWithId = props => {
            return <CampsiteInfo campsite={this.state.campsites.filter(campsite => campsite.id === +props.match.params.campsiteId)[0]} comments={this.state.comments.filter(comment => comment.campsiteId === +props.match.params.campsiteId)} />;
        };
